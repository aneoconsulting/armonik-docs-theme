...
::list{type="primary"}
- Create a new file in the `.github/workflows` directory named `ci-docs.yml`. But you can also add it to your existing CI workflow.
...
```yaml [.github/workflows/ci-docs.yml]
name: CI Docs
